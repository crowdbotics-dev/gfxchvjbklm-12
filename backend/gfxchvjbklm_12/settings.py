"""
Django settings for gfxchvjbklm_12 project.
...
ROOT_URLCONF = 'gfxchvjbklm_12.urls'
...
WSGI_APPLICATION = 'gfxchvjbklm_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gfxchvjbklm_12 API",
    "DESCRIPTION": "API documentation for gfxchvjbklm_12 App",
    "VERSION": "v1",
}
